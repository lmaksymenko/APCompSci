...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorTemple()
  {
   ...
   System.out.println("mirrorTemple loop has run: " + counter + " times");
  }
  ...
  public void grayscale() {
	  ...
	  for(Pixel[] rows : pixels){
		  ...
		  for(Pixel pixel : rows) {
			  double avg = pixel.getGreen() + pixel.getBlue() + pixel.getRed() / 3.0;
					   pixel.setRed((int) avg);
					   pixel.setGreen((int) avg);
					   pixel.setBlue((int) avg); 
		  }
	  }
	}
  ...
  public void myCollage()
  {
    ...
    Picture flowerNegated = new Picture("flower1.jpg");
    flowerNegated.negate();
    this.copy(flowerNegated,300,300);
    
    Picture flowerGray = new Picture("flower1.jpg");
    flowerGray.grayscale();
    
    this.copy(flowerNegated,0,300);
